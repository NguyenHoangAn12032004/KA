/**
 * Vietnamese to English Name Converter
...
/**
 * Examples of usage:
 * convertVietnameseToEnglish("thu nguyễn thị") → "thu nguyen thi"
 * convertVietnameseNameToEnglish("thu nguyễn thị") → "Thu Nguyen Thi"
 * convertVietnameseNames("Thu", "Nguyễn Thị") → { firstName: "Thu", lastName: "Nguyen Thi", fullName: "Thu Nguyen Thi" }
 */
