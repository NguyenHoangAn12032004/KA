...
async function testTrends() {
  try {
    ...
    await prisma.$executeRaw`DROP FUNCTION IF EXISTS get_dashboard_analytics(integer)`;
    
    console.log('📊 Creating new analytics function with trends...');
    
    // Read and create new function
    ...
    console.log('📊 Analytics with trends:');
    console.log('- Job Views (30d):', data.job_views_30d);
    console.log('- Applications (30d):', data.applications_30d);
    console.log('- Interviews (30d):', data.interviews_30d);
    console.log('- Job Views Trend:', data.job_views_trend + '%');
    console.log('- Applications Trend:', data.applications_trend + '%');
    console.log('- Interviews Trend:', data.interviews_trend + '%');
